...
$sql = "INSERT INTO despesas VALUES (0,'$tipo','$valor','$qtd','$data')";
...
if($res){
	echo"<p><br />Informações gravadas com sucesso!<p>";
	return("cadDespesa.php");
}else{
	echo "<p><br />Erro ao gravar as informações!";
}
rodape();
?>